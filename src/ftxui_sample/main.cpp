...
// configuration step. It creates a namespace called `tcpp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", tcpp::cmake::project_name, tcpp::cmake::project_version) };
